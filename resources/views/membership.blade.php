...
<body class="bg-white text-dark-500">
    ...
    <header id="navbar" class="fixed w-full bg-white z-50 transition-all duration-300 py-4">
        <div class="container mx-auto px-4 flex justify-between items-center">
            <a href="{{ route('home') }}" class="flex items-center space-x-2">
                <img src="{{ asset('images/niotim-logo.jpeg') }}" alt="NIOTIM Logo"
                    class="w-10 h-10 rounded-full object-cover">
            </a>
            <nav class="hidden lg:flex space-x-8">
                <a href="{{ route('home') }}"
                    class="text-dark-600 hover:text-primary-500 transition font-medium">Home</a>
                <a href="{{ route('about') }}"
                    class="text-dark-600 hover:text-primary-500 transition font-medium">About</a>
                <a href="{{ route('membership') }}"
                    class="text-primary-500 font-semibold border-b-2 border-primary-500 pb-1">Membership</a>
                <a href="{{ route('communique') }}"
                    class="text-dark-600 hover:text-primary-500 transition font-medium">Communiqué</a>

                <a href="{{ route('news.index') }}"
                    class="text-dark-600 hover:text-primary-500 transition font-medium">News</a>
                <a href="{{ route('home') }}#contact"
                    class="text-dark-600 hover:text-primary-500 transition font-medium">Contact</a>
            </nav>
            <button id="mobile-menu-button" class="lg:hidden text-dark-600"><i
        ...
        <div id="mobile-menu" class="mobile-menu fixed top-0 right-0 w-64 h-full bg-white shadow-2xl z-50 p-6">
            <div class="flex justify-between items-center mb-8"><span
                    class="font-bold text-xl text-primary-600">NIOTIM</span><button id="close-menu"
                    class="text-2xl">&times;</button></div>
            <nav class="flex flex-col space-y-5">
                <a href="#" class="text-dark-700 hover:text-primary-500">Home</a>
                <a href="#" class="text-dark-700 hover:text-primary-500">About</a>
                <a href="#"
                    class="text-primary-500 font-semibold border-l-4 border-primary-500 pl-2">Membership</a>
            ...
            <div class="mb-8 flex flex-col md:flex-row gap-4 justify-between items-center">
                <div class="relative w-full md:w-96">
                    ...
                    <input type="text" id="searchInput"
                        placeholder="Search by name, institution, or membership number..."
                ...
                <div class="flex gap-2">
                    <button class="filter-btn active bg-primary-500 text-white px-4 py-2 rounded-lg"
                        data-grade="all">All</button>
                    <button class="filter-btn bg-gray-200 text-gray-700 px-4 py-2 rounded-lg hover:bg-primary-100"
                        data-grade="Fellow">Fellows</button>
                    <button class="filter-btn bg-gray-200 text-gray-700 px-4 py-2 rounded-lg hover:bg-primary-100"
    ...
    <button id="back-to-top"
        class="fixed bottom-8 right-8 w-12 h-12 rounded-full bg-primary-500 text-white shadow-lg opacity-0 transition-opacity"><i
    ...
    <script>
        ...
        const membersData = [{
                sn: 1,
                no: "AMN0001",
                name: "Mr Imoh, Oghenekaro Benson",
                work: "Federal Polytechnic, Orogun, Delta State",
                email: "imohoghenekaro@gmail.com",
                phone: "08106966024",
                grade: "Asst. Member"
            },
            {
                sn: 2,
                no: "AMN0002",
                name: "Wakgaka, Cephas Daniel",
                work: "Plateau State Polytechnic, Barkin Ladi",
                email: "cdwakgaka@gmail.com",
                phone: "08030462458",
                grade: "Asst. Member"
            },
            {
                sn: 3,
                no: "AMN0003",
                name: "Ujah John Augustine",
                work: "Federal Polytechnic, Orogun, Delta State",
                email: "talk2johnbosco2@gmail.com",
                phone: "07065615078 / 09064678280",
                grade: "Asst. Member"
            },
            {
                sn: 4,
                no: "FN0001",
                name: "Dr Akewusola Lanre",
                work: "Kwara State Polytechnic, Ilorin",
                email: "akewusolalanre@yahoo.com",
                phone: "08035257252",
                grade: "Fellow"
            },
            {
                sn: 5,
                no: "FN0002",
                name: "Dr Oludele, Lydia Yemisi",
                work: "Osun State Polytechnic, Iree",
                email: "yemisioludele70@gmail.com",
                phone: "08033479720",
                grade: "Fellow"
            },
            {
                sn: 6,
                no: "FN0003",
                name: "Dr. Garba, Gude Ado",
                work: "Federal University of Science and Technology, Kabo, Kano",
                email: "adogarba@fedpolykabo.edu.ng",
                phone: "08066067606",
                grade: "Fellow"
            },
            {
                sn: 7,
                no: "FN0004",
                name: "Dr Osakwe, Stephen Onyeanwuna",
                work: "Delta State Polytechnic, Otefe-Oghara",
                email: "steveosakwe1212@gmail.com",
                phone: "07033228533",
                grade: "Fellow"
            },
            {
                sn: 8,
                no: "FN0005",
                name: "Dr Onche, Virginia Ochanya",
                work: "University of Ibadan",
                email: "vidogwu39@yahoo.com",
                phone: "08023337899",
                grade: "Fellow"
            },
            {
                sn: 9,
                no: "FN0006",
                name: "Dr. Folorunso, Isaac Oluwole",
                work: "University of Ilesa",
                email: "folounsooluwole@gmail.com",
                phone: "09034719313",
                grade: "Fellow"
            },
            {
                sn: 10,
                no: "FN0007",
                name: "Dr Akasi, Sunday Ebhodaghe",
                work: "Federal Polytechnic, Ede",
                email: "aksunebo@yahoo.co.uk",
                phone: "08033802347",
                grade: "Fellow"
            },
            {
                sn: 11,
                no: "FN0012",
                name: "Mrs. Arikwandu, Sympathy Ogechukwu",
                work: "Federal Polytechnic, Bauchi",
                email: "soarikwandu@fptb.edu.ng",
                phone: "08025257818",
                grade: "Fellow"
            },
            {
                sn: 12,
                no: "FN0013",
                name: "Dr (Mrs) Ifeolu, Adepeju Anike",
                work: "Federal Polytechnic, Offa",
                email: "Adepeju.ifeolu@gmail.com",
                phone: "08085039286",
                grade: "Fellow"
            },
            {
                sn: 13,
                no: "FN0014",
                name: "Dr Elemure, Clement Boluwaji",
            ...
            },
            {
                sn: 14,
                no: "FN0015",
                name: "Dr Idiake, Christiana Omoye",
                work: "Lagos State University of Science and Technology",
                email: "christianaomoye@yahoo.com",
                phone: "08023656549",
                grade: "Fellow"
            },
            {
            ...
            },
            {
                sn: 16,
                no: "FN0017",
                name: "Dr Nna-Emmanuel, Sarah Wariboko",
                work: "Ken SaroWiwa Polytechnic, Bori",
                email: "sarahnna01@gmail.com",
                phone: "07060855967",
                grade: "Fellow"
            },
            {
                sn: 17,
                no: "FN0018",
                name: "Dr Adepoju Adenike Abiodun",
                work: "Tai Solarin University of Education",
                email: "adenikepoju@gmail.com",
                phone: "08105667121",
                grade: "Fellow"
            },
            {
                sn: 18,
                no: "FN0019",
                name: "Dr. Adeyeye Munirat Opeyemi",
                work: "Bamidele Olumilua University of Education",
                email: "adeyeye.ope@gmail.com",
                phone: "08030715156",
                grade: "Fellow"
            },
            {
            ...
            },
            {
                ...
                email: "drbenowaji2013@gmail.com",
                phone: "07036965109",
                grade: "Member"
            },
            {
                ...
                work: "Federal Polytechnic, Offa",
                email: "asimegbegabriel1@gmail.com",
                phone: "07062857833",
                grade: "Member"
            },
            {
            ...
            },
            {
                ...
                email: "peter.alikornwob@portharcourtpoly.edu.ng",
                phone: "08132922362",
                grade: "Member"
            },
            {
                ...
                work: "Federal Polytechnic, Offa",
                email: "abakeenterprise8@gmail.com",
                phone: "08169901606",
                grade: "Member"
            },
            {
                ...
                email: "Bolajimada1970@gmail.com",
                phone: "08033584597",
                grade: "Member"
            },
            {
                ...
                email: "Nnajiflorence15@gmail.com",
                phone: "07064815343",
                grade: "Member"
            },
            {
                ...
                email: "adielegoodluck5@gmail.com",
                phone: "09132800227",
                grade: "Member"
            },
            {
                ...
                email: "emmanuelikoromasoma@gmail.com",
                phone: "07063254607",
                grade: "Member"
            },
            {
                ...
                work: "Captain Elechi Amadi Polytechnic, Rumuola",
                email: "emmanuel.nweke@portharcourtpoly.edu.ng",
                phone: "08037817527",
                grade: "Member"
            },
            {
                ...
                email: "chinyereogwe77@gmail.com",
                phone: "08032543247",
                grade: "Member"
            },
            {
            ...
            },
            {
                ...
                work: "Rivers State University",
                email: "priscaomunakee90@gmail.com",
                phone: "08039429801",
                grade: "Member"
            },
            {
                ...
                work: "Bamidele Olumilua University of Education",
                email: "abiolaveronica3@gmail.com",
                phone: "08166490138",
                grade: "Member"
            },
            {
                ...
                email: "titilayosodiyan@gmail.com",
                phone: "07066465706",
                grade: "Member"
            },
            {
            ...
            },
            {
                ...
                email: "Cynthiairoka79@gmail.com",
                phone: "08169611723",
                grade: "Member"
            },
            {
                ...
                email: "Kelechimary776@gmail.com",
                phone: "08188577187",
                grade: "Member"
            },
            {
                ...
                work: "Yaba College of Technology",
                email: "oluwaseye.ige16@gmail.com",
                phone: "07035559223",
                grade: "Member"
            },
            {
            ...
            },
            {
                ...
                work: "Capt. Elechi Amadi Polytechnic, Rumuola",
                email: "peace.kalagbor@gmail.com",
                phone: "08037171642",
                grade: "Member"
            },
            {
                ...
                email: "ukata4mephilip@yahoo.com",
                phone: "08038877937",
                grade: "Member"
            },
            {
                ...
                email: "Julianahtoyin9@gmail.com",
                phone: "07068081089",
                grade: "Member"
            },
            {
            ...
            },
            {
                ...
                email: "Zainabideen2453@gmail.com",
                phone: "08033025519",
                grade: "Member"
            },
            {
            ...
            },
            {
                ...
                work: "Kwara State Polytechnic, Ilorin",
                email: "olabisigbankole@gmail.com",
                phone: "08032412957",
                grade: "Member"
            },
            {
                ...
                email: "papawisman4life@gmail.com",
                phone: "09024182675",
                grade: "Member"
            },
            {
                ...
                work: "Bamidele Olumilua University of Education",
                email: "olayanjutobi4christ@gmail.com",
                phone: "08058526930",
                grade: "Member"
            },
            {
            ...
            },
            {
                ...
                email: "adegboyetajudeen@yahoo.com",
                phone: "07032496057",
                grade: "Member"
            },
            {
                ...
                email: "obelem.alalibo@ust.edu.ng",
                phone: "08056211223",
                grade: "Member"
            },
            {
        ...
        window.addEventListener('scroll', () => {
            if (window.scrollY > 300) backToTop.classList.add('opacity-100');
            else backToTop.classList.remove('opacity-100');
        });
