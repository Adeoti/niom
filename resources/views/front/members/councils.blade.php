...
<head>
    ...
    <title>Our Council Members - NIOTIM</title>    
    <!-- Required Libraries -->
    ...
    <section class="section-padding bg-white">
        <div class="container mx-auto px-4">
            <div class="mb-8 flex justify-between items-center">
                <h2 class="text-2xl font-bold text-primary-500">Our Council Members <span class="text-dark-600 text-lg font-normal">(<span id="totalMembers">{{ $stats['total'] }}</span> total)</span></h2>
            ...
            if (members.length === 0) {
                membersContainer.innerHTML = `
                    <div class="col-span-4 text-center py-12">
                        ...
                        <h3 class="text-xl font-semibold text-dark-600 mb-2">No council member found</h3>
