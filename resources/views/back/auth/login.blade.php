        ...
        <div class="auth-card">
            <div class="auth-header">
                <div class="w-16 h-16 rounded-full bg-white text-primary-500 flex items-center justify-center text-2xl font-bold mx-auto mb-4">
                    <center><img src="{{ asset('images/niotim-logo.jpeg') }}" style="height:70px;" alt=""></center>
                </div>
            ...
            'email' => 'The provided credentials do not match our records.',
                    ...
                    <div class="flex items-center justify-between mb-5">
                        <div class="flex items-center">
                            <input type="checkbox" id="remember" name="remember" class="h-4 w-4 text-primary-500 focus:ring-primary-400 border-gray-300 rounded">
            ...
            <div class="auth-footer">
                <p class="text-dark-600">Not a member yet? <a href="{{ route('membership.create') }}" class="toggle-form">Apply for membership</a></p>
            </div>
        </div>
    </div>
</body>
